...
import cl.ibapps.reportapp.repository.LabelRepository;
...
class LabelResourceIT {
    ...
    public static Label createEntity(EntityManager em) {
        Label label = new Label().description(DEFAULT_DESCRIPTION);
        return label;
    }
    ...
    public static Label createUpdatedEntity(EntityManager em) {
        Label label = new Label().description(UPDATED_DESCRIPTION);
        return label;
    }
    ...
    void putNewLabel() throws Exception {
        ...
        updatedLabel.description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateLabelWithPatch() throws Exception {
        ...
        partialUpdatedLabel.description(UPDATED_DESCRIPTION);
