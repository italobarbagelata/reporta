...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSPECTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_INSPECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INSPECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INSPECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INSPECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INSPECTION actions', async () => {
      const expectedActions = [
        {
