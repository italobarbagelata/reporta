...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FINALOVERALL_LIST actions', async () => {
    ...
    it('dispatches FETCH_FINALOVERALL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FINALOVERALL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FINALOVERALL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FINALOVERALL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FINALOVERALL actions', async () => {
      const expectedActions = [
        {
