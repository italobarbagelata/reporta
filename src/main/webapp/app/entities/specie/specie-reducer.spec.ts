...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './specie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPECIE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SPECIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SPECIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SPECIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SPECIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SPECIE actions', async () => {
      const expectedActions = [
        {
