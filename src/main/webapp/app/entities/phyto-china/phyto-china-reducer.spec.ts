...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PHYTOCHINA_LIST actions', async () => {
    ...
    it('dispatches FETCH_PHYTOCHINA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PHYTOCHINA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PHYTOCHINA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PHYTOCHINA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PHYTOCHINA actions', async () => {
      const expectedActions = [
        {
