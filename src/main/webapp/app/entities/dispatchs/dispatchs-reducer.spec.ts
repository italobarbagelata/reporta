...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './dispatchs.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISPATCHS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DISPATCHS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DISPATCHS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DISPATCHS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DISPATCHS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DISPATCHS actions', async () => {
      const expectedActions = [
        {
