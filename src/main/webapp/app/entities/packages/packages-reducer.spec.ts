...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './packages.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PACKAGES_LIST actions', async () => {
    ...
    it('dispatches FETCH_PACKAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PACKAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PACKAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PACKAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PACKAGES actions', async () => {
      const expectedActions = [
        {
