...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LISTSIZES_LIST actions', async () => {
    ...
    it('dispatches FETCH_LISTSIZES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LISTSIZES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LISTSIZES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LISTSIZES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LISTSIZES actions', async () => {
      const expectedActions = [
        {
