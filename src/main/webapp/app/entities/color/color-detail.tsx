...
export const ColorDetail = (props: RouteComponentProps<{ id: string }>) => {
    ...
    <Row>
      <Col md="8">
        <h2 data-cy="colorDetailsHeading">
          <Translate contentKey="reportappApp.color.detail.title">Color</Translate>
        </h2>
