...
import { getEntity, deleteEntity } from './color.reducer';

export const ColorDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="reportappApp.color.delete.question">
        <Translate contentKey="reportappApp.color.delete.question" interpolate={{ id: colorEntity.id }}>
