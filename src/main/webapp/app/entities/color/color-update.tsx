...
export const ColorUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="reportappApp.color.home.createOrEditLabel" data-cy="ColorCreateUpdateHeading">
            <Translate contentKey="reportappApp.color.home.createOrEditLabel">Create or edit a Color</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('reportappApp.color.description')}
