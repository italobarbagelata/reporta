...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './variety.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VARIETY_LIST actions', async () => {
    ...
    it('dispatches FETCH_VARIETY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VARIETY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VARIETY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VARIETY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VARIETY actions', async () => {
      const expectedActions = [
        {
