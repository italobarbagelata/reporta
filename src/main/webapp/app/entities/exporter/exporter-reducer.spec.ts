...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './exporter.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXPORTER_LIST actions', async () => {
    ...
    it('dispatches FETCH_EXPORTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXPORTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXPORTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXPORTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXPORTER actions', async () => {
      const expectedActions = [
        {
