...
/**
 * REST controller for managing {@link cl.ibapps.reportapp.domain.Inspection}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Inspection> partialUpdateInspection(
        ...
        Optional<Inspection> result = inspectionRepository
            ...
            .map(existingInspection -> {
                if (inspection.getReportDate() != null) {
                    existingInspection.setReportDate(inspection.getReportDate());
                }
                if (inspection.getDescription() != null) {
                    existingInspection.setDescription(inspection.getDescription());
                }
                if (inspection.getPlace() != null) {
                    existingInspection.setPlace(inspection.getPlace());
                }
                if (inspection.getInspectionDate() != null) {
                    existingInspection.setInspectionDate(inspection.getInspectionDate());
                }
                if (inspection.getGrower() != null) {
                    existingInspection.setGrower(inspection.getGrower());
                }
                if (inspection.getPackingDate() != null) {
                    existingInspection.setPackingDate(inspection.getPackingDate());
                }
                if (inspection.getObservations() != null) {
                    existingInspection.setObservations(inspection.getObservations());
                }
                if (inspection.getFinalRecomendations() != null) {
                    existingInspection.setFinalRecomendations(inspection.getFinalRecomendations());
                }
                if (inspection.getExtraDetails() != null) {
                    existingInspection.setExtraDetails(inspection.getExtraDetails());
                }
